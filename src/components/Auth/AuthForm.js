...
const AuthForm = () => {
  ...
  const submitHandler = (event) => {
    ...
    if (isLogin) {
      ...
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDkoRg6yLJuB6DOtUkXdGlhK11ZyjV3jCM";
  ...
  const forgotPasswordHandler = () => {
    const enteredEmail = emailInputRef.current.value;
    const passUrl =
      "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyDkoRg6yLJuB6DOtUkXdGlhK11ZyjV3jCM";
    fetch(passUrl, {
      method: "POST",
      body: JSON.stringify({
